    ...
    if 1:
        ...
        for x in data_loader_val:
            ...
            evaluator = HICOEvaluator(
                preds,
                gts,
                data_loader_val.dataset.rare_triplets,
                data_loader_val.dataset.non_rare_triplets,
                data_loader_val.dataset.correct_mat,
                args=args,
            )
            ...
            param_dicts = [
                {
                    "params": [
                        ...
                        and "visual_projection" not in n
                        and "obj_visual_projection" not in n
                        and p.requires_grad
                    ]
                },
                {
                ...
                },
                {
                    "params": [
                        p
                        for n, p in model_without_ddp.named_parameters()
                        if ("visual_projection" in n or "obj_visual_projection" in n)
                        and p.requires_grad
                    ],
                    "lr": args.lr_clip,
                },
            ...
            param_dicts = [
                ...
                },
                {
                    "params": [
                        p
                        for n, p in model_without_ddp.named_parameters()
                        if "visual_projection" in n and p.requires_grad
                    ],
                    "lr": args.lr_clip,
                },
            ]
            ...
            param_dicts = [
                ...
                },
                {
                    "params": [
                        p
                        for n, p in model_without_ddp.named_parameters()
                        if "obj_visual_projection" in n and p.requires_grad
                    ],
                    "lr": args.lr_clip,
                },
            ]
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(
        "GEN VLKT training and evaluation script", parents=[get_args_parser()]
    )
